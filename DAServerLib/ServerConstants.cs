...
namespace Darkages
{
    public class ServerConstants
    {
        ...
        [JsonProperty] public string[] GameMasters = { "lol", "tester", "wren" }; // These players will have access DEV commands ingame.

        [JsonProperty] public string ServerDev = ""; //add your name here so people know who is running this server.

        [JsonProperty] public string ProjectDev = "Dean (Wren) [deanmcpw@gmail.com]"; //you can decide if you want to change this.
        ...
        [JsonProperty] public string HelperMenuTemplateKey = "Friendly Helper";
        ...
        [JsonProperty] public string MerchantTradeErrorMessage = "We was not able to conduct business.";
        ...
        [JsonProperty] public string NotEnoughGoldToDropMsg = "You don't have this much gold.";
